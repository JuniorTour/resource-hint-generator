...
try {
  (function (prefetchFilesPath, preconnectDomains) {
    const crossOriginAttrVal = __CROSS_ORIGIN_VALUE_PLACEHOLDER__;
    const CDN_HOST = __PUBLIC_PATH_PLACEHOLDER__;
  ...
  })([__PREFETCH_SRC_DATA_PLACEHOLDER__], [__PRECONNECT_DATA_PLACEHOLDER__]);
} catch (err) {
